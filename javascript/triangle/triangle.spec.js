...
describe('Triangle', () => {
  ...
  test('degenerate triangles are illegal', () => {
    const triangle = new Triangle(6, 4, 2);
    expect(triangle.kind.bind(triangle)).toThrow();
  });

  test('degenerate triangles are illegal 2', () => {
    const triangle = new Triangle(2, 4, 2);
    expect(triangle.kind.bind(triangle)).toThrow();
  });

  test('degenerate triangles are illegal 3', () => {
    const triangle = new Triangle(6, 4, 10);
    expect(triangle.kind.bind(triangle)).toThrow();
  });
});
